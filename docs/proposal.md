...
### Firebase
- **Relation to my App**: Firebase is a platform that provides backend services like real-time databases, authentication, and analytics, which can help me with my ridesharing app[7].
...
- **Key Features**: Key features relevant to my project include:
  ...
  - Firebase Cloud Storage: Firebase Cloud Storage is my choice for storing and serving user-generated content in my ridesharing app. It is basically built for app developers who need to store and serve user-generated content[8]
...
- [3] Figma, "Figma - Android UI Kit," Figma. https://www.figma.com/community/file/1237551184114564748 (accessed Sept. 17, 2024).
...
- [6] JetBrains, "Kotlin for Android Developers," Kotlin Help. https://kotlinlang.org/docs/android-overview.html (accessed Sept. 4, 2024).

- [7] Google, "Firebase for Android," Firebase. https://firebase.google.com/docs/android/setup (accessed Sept. 4, 2024).
...
- [9] Google, "Jetpack Compose," Android Developers. https://developer.android.com/compose (accessed Sept. 5, 2024).
